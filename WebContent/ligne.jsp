	...
	<div class="slide story" id="slide-1" data-slide="1">
		<div class="container">
			<div id="home-row-1" class="row clearfix">
				<div class="col-12">
					...
					<h4 class="font-thin"><span class="font-semibold">GESTION DES LIGNES</span></h4>
				</div><!-- /col-12 -->
			</div><!-- /row -->
		</div><!-- /container -->
		...
		<div class="container">
			<div id="contact-row-4" class="row">
				...
				<div class="col-12 col-sm-2 with-hover-text">
					<p><a href="ligneAjout.jsp"><i class="icon icon-plus"></i></a></p>
					<span class="hover-text font-light ">AJOUT LIGNE</span>
				</div><!-- /col12 -->
				<div class="col-12 col-sm-2 with-hover-text">
					<p><a  href="ligneRecherche.jsp"><i class="icon icon-search"></i></a></p>
					<span class="hover-text font-light ">CHERCHER LIGNE</span>
				</div><!-- /col12 -->
